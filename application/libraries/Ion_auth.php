...
class Ion_auth
{
	 ...
	 * @author Mathew
	 */
	public function register($identity, $password, $email, $additional_data = array(), $group_ids = array(), $sendmail = false)
	{
		...
		if (!$email_activation) {
			...
			if (!$this->config->item('use_ci_email', 'ion_auth') || !$sendmail) {
