...
/**
 * Vnk Class for CodeIgniter
 *
 * This class is based on Laravel's Blade templatiing system!
...
class Vnk
{
    ...
    /**
     *  The file extension for the vnk template
     *
     *  @var   string
     */
    public $vnk_ext = '.vnk.php';
    ...
    /**
     *  Global array of data for Vnk Template
     *
     *  @var   array
     */
    ...
    /**
     *  CodeIgniter Libraries to autoload with Vnk-Library
     *
     *  @var   array
     */
    ...
    /**
     *  CodeIgniter Helpers to autoload with Vnk-Library
     *
     *  @var   array
     */
    ...
    /**
     *  All of the compiler methods used by Vnk to simulate
    ...
    public function __construct(array $params = array())
    {
        ...
        $this->CI->benchmark->mark('vnk_execution_time_start');	//	Start the timer

        $this->CI->load->driver('cache');	//	Load CI cache driver
        $this->CI->config->load('vnk');	//	Load Vnk config file
        ...
        log_message('info', 'Vnk Template Class Initialized');
    }
    ...
    {
        $this->vnk_ext = config_item('vnk_ext');
    ...
    /**
     *  Sets one single data to Vnk Template
     *
     *  @param    string   $name
     *  @param    mixed    $value
     *  @return   Vnk
    ...
    /**
     *  Sets one or more data to Vnk Template
     *
     *  @param   mixed   $data
     *  @param   mixed   $value
     *  @return  Vnk
    ...
    /**
     *  Appends or concatenates a value to a data in Vnk Template
     *
    ...
    public function exists($filename, $show_error = false)
    {
        ...
        $default_path = VIEWPATH . $view_name . $this->vnk_ext;

        //	If you are using Modular Extensions it will be detected
        if (method_exists($this->CI->router, 'fetch_module')) {
            $module = $this->CI->router->fetch_module();
            list($path, $_view) = Modules::find($view_name . $this->vnk_ext, $module, 'views/');
        ...
        if (is_file($default_path)) {
            ...
            if ($show_error === true) {
                show_error('Sorry! We couldn\'t find the view: ' . $view_name . $this->vnk_ext);
            } else {
                return false;
            }
        }
    ...
    protected function _run($template, $data = null)
    {
        ...
        $this->CI->benchmark->mark('vnk_execution_time_end');	//	Stop the timer
