 ...
 */
$config['site_title'] = 'eSystem AE';       	// Site Title, example.com
$config['admin_email'] = 'admin@esystem.ae'; 	// Admin Email, admin@example.com
...
$config['user_expire'] = 60 * 60 * 24 * 7;               // How long to remember the user (seconds). Set to zero for no expiration
...
$config['forgot_password_expiration'] = 60 * 60 * 24;               // The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
...
$config['message_start_delimiter'] = '<div class="alert alert-info alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>';
$config['message_end_delimiter'] = '</div>'; // Message end delimiter
// Error message start delimiter
$config['error_start_delimiter'] = '<div class="alert alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>';
