...
class Ion_auth_model extends CI_Model
{
	 ...
	 * @author Ben Edmunds
	 */
	public function messages($delimiters = true)
	{
		$_output = '';
	 ...
	 */
	public function messages_array($langify = true, $delimiters = true)
	{
		if ($langify) {
			$_output = array();
			foreach ($this->messages as $message) {
	 ...
	 * @author Ben Edmunds
	 */
	public function errors($delimiters = true)
	{
		$_output = '';
		foreach ($this->errors as $error) {
			// use delimiter from config
			if ($delimiters) {
	 ...
	 * @author Raul Baldner Junior
	 */
	public function errors_array($langify = true, $delimiters = true)
	{
		if ($langify) {
			$_output = array();
			foreach ($this->errors as $error) {
