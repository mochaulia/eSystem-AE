...
<html lang="en">
    ...
    <body id="gradient">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-12">
                    ...
                    <div id="newsUpdate" class="x_panel_b x_panel"></div>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="x_panel_b x_panel" style="min-height:900px">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    ...
                    <div class="x_panel_b x_panel" style="min-height:900px"1>
        ...
        <!-- <script src="{{ js('app/features/bulletin.js') }}"></script> -->
    </body>
</html>
